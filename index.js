...
case 'menu': {
  ...
  const caption = `┌── *SYSTEM BOOT : SANAKA.AI* ───────────────────┐
│
...
`;
  ...
  const buttons = {
    reply_markup: {
      inline_keyboard: [
        [
          { text: 'Channel WhatsApp', url: 'https://whatsapp.com/channel/0029VarFmXW4Spk7e033IG0W' },
        ],
        [
          { text: 'Developer', url: 'https://t.me/ShinomiyaShop' },
          { text: 'YouTube', url: 'https://www.youtube.com/@Ayamenew' },
        ],
      ],
    },
    parse_mode: 'Markdown',
